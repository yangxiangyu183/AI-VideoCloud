...
<el-date-picker v-model="searchInfo.alertTime" type="datetime" placeholder="搜索条件"></el-date-picker></el-form-item>
            ...
            <el-form-item label="摄像头点位id" prop="cameraId">
  <el-input v-model.number="searchInfo.cameraId" placeholder="搜索条件" />
   ...
   <template #default="scope">{{ formatDate(scope.row.alertTime) }}</template>
            ...
            <el-table-column align="left" label="摄像头点位id" prop="cameraId" width="120" />
    ...
    <el-date-picker v-model="formData.alertTime" type="date" style="width:100%" placeholder="选择日期" :clearable="true" />
            ...
            <el-form-item label="摄像头点位id:" prop="cameraId">
    <el-input v-model.number="formData.cameraId" :clearable="true" placeholder="请输入摄像头点位id" />
</el-form-item>
          </el-form>
    </el-drawer>
    ...
    {{ detailForm.alertTime }}
                    ...
                    <el-descriptions-item label="摄像头点位id">
    {{ detailForm.cameraId }}
</el-descriptions-item>
            </el-descriptions>
        </el-drawer>
