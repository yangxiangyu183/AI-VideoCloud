  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="ptype字段" prop="ptype" width="120" />

            <el-table-column align="left" label="v0字段" prop="v0" width="120" />

            <el-table-column align="left" label="v1字段" prop="v1" width="120" />

            <el-table-column align="left" label="v2字段" prop="v2" width="120" />

            <el-table-column align="left" label="v3字段" prop="v3" width="120" />

            <el-table-column align="left" label="v4字段" prop="v4" width="120" />

            <el-table-column align="left" label="v5字段" prop="v5" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button v-auth="btnAuth.edit" type="primary" link icon="edit" class="table-button" @click="updateCasbinRuleFunc(scope.row)">编辑</el-button>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    <el-descriptions-item label="ptype字段">
    {{ detailForm.ptype }}
</el-descriptions-item>
                    <el-descriptions-item label="v0字段">
    {{ detailForm.v0 }}
</el-descriptions-item>
                    <el-descriptions-item label="v1字段">
    {{ detailForm.v1 }}
</el-descriptions-item>
                    <el-descriptions-item label="v2字段">
    {{ detailForm.v2 }}
</el-descriptions-item>
                    <el-descriptions-item label="v3字段">
    {{ detailForm.v3 }}
</el-descriptions-item>
                    <el-descriptions-item label="v4字段">
    {{ detailForm.v4 }}
</el-descriptions-item>
                    <el-descriptions-item label="v5字段">
    {{ detailForm.v5 }}
</el-descriptions-item>
            </el-descriptions>
        </el-drawer>
...
const getTableData = async() => {
  const table = await getCasbinRuleList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
// 更新行
const updateCasbinRuleFunc = async(row) => {
...
// 删除行
const deleteCasbinRuleFunc = async (row) => {
