  ...
  <div>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate v-auth="btnAuth.exportTemplate" template-id="user_AdminUser" />
            <ExportExcel v-auth="btnAuth.exportExcel" template-id="user_AdminUser" filterDeleted/>
            <ImportExcel v-auth="btnAuth.importExcel" template-id="user_AdminUser" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="用户的账号状态" prop="status" width="120">
    <template #default="scope">
    {{ filterDict(scope.row.status,StatusOptions) }}
    </template>
</el-table-column>
            <el-table-column align="left" label="用户的使用权限" prop="permissions" width="120">
    <template #default="scope">
    ...
    <template #default="scope">
    {{ filterDict(scope.row.idAdmin,id_adminOptions) }}
    </template>
</el-table-column>
    ...
    {{ detailForm.adminPassword }}
</el-descriptions-item>
                    <el-descriptions-item label="管理员账号">
    {{ detailForm.adminName }}
</el-descriptions-item>
                    <el-descriptions-item label="用户的账号状态">
    {{ detailForm.status }}
</el-descriptions-item>
                    <el-descriptions-item label="用户的使用权限">
