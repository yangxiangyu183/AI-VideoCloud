...
// Author [yourname](https://github.com/yourname)
func (alertService *AlertService)DeleteAlert(ctx context.Context, ID string) (err error) {
	err = global.GVA_DB.Delete(&alert_video.Alert{},"id = ?",ID).Error
	return err
}

// DeleteAlertByIds 批量删除alert表记录
// Author [yourname](https://github.com/yourname)
func (alertService *AlertService)DeleteAlertByIds(ctx context.Context, IDs []string) (err error) {
	err = global.GVA_DB.Delete(&[]alert_video.Alert{},"id in ?",IDs).Error
	return err
}
