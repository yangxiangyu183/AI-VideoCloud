...
type MonitorDevice struct {
  ...
  GroupId  *int `json:"groupId" form:"groupId" gorm:"comment:关联分组id;column:group_id;size:19;" binding:"required"`  //关联分组id
  StreamUrl  *string `json:"streamUrl" form:"streamUrl" gorm:"comment:视频流地址;column:stream_url;" binding:"required"`  //视频流地址
  Status  *bool `json:"status" form:"status" gorm:"comment:设备状态：1-在线 2-离线 3-故障;column:status;"`  //设备状态：1-在线 2-离线 3-故障
